...
class ContentPostAdapter(
    ...
    FirestoreRecyclerAdapter<BookHelper, ContentPostAdapter.ViewHolder>(options) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.library_cell, parent, false)
